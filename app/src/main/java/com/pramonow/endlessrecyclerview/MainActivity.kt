...
import com.pramonow.endlessrecyclerviewmodule.EndlessRecyclerView
import com.pramonow.endlessrecyclerviewmodule.EndlessScrollCallback
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Example of using lambda method for the callback
        /*endlessRecylerView.setEndlessScrollCallback {
                //Now list view can be set so that it will block load until certain task finish
                endlessRecylerView.blockLoading()
